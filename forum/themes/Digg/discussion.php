...
<li id="Discussion_'.$Discussion->DiscussionID.'" class="Discussion'.$Discussion->Status.($Discussion->CountComments == 1?' NoReplies':'').($this->Context->Configuration['USE_CATEGORIES'] ? ' Category_'.$Discussion->CategoryID:'').($Alternate ? ' Alternate' : '').'">
   ...
   <ul class="SocialBookmarks">
		 <li class="AddTo">
		 <a target="_blank" href="http://technorati.com/faves?add='.$UnreadUrl.'"><img src="'.$this->Context->Configuration['DEFAULT_STYLE'].'technorati.png" width="16" height="16" alt="Add to technorati" title="Add to technorati" /></a>
		 </li>
		 <li class="AddTo">
		 <a target="_blank" href="http://del.icio.us/post?v=4&amp;noui&amp;jump=close&amp;url='.$UnreadUrl.'"><img src="'.$this->Context->Configuration['DEFAULT_STYLE'].'delicious.png" width="16" height="16" alt="Add to delicious" title="Add to delicious" /></a>
		 </li>
		  <li class="AddTo">
         <a target="_blank" href="http://digg.com/submit?phase=2&amp;url='.$UnreadUrl.'"><img src="'.$this->Context->Configuration['DEFAULT_STYLE'].'digg.png" width="16" height="16" alt="Digg it" title="Add to digg" /></a>
		 </li>
		 </ul>
