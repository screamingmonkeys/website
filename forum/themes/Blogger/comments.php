...
if ($this->Context->WarningCollector->Count() > 0) {
	...
	$CommentList .= '<div class="ContentInfo Top">
		...
		.'</h1>
		<div class="PageScroll"><a href="#pgbottom"><img src="themes/Blogger/styles/default/go-down.gif" title="'.$this->Context->GetDefinition('BottomOfPage').'" alt="'.$this->Context->GetDefinition('BottomOfPage').'" width="13" height="11" /></a></div>
		<div class="PageInfo">
			<p>'.$PageDetails.'</p>
			'.$PageList.'
		</div>
